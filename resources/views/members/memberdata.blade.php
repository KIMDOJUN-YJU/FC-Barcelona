                ...
                @csrf
                        <div class="col-nd-8">
                            <table class="table" id="tableid">
                             ...
                             <button type="button" id="create" onclick="create()" class="btn btn-outline-primary" style="width:90px; float:right">선수추가</button>
        ...
        $(document).on("click",".clickable", function(){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    str += '</br><h4>포지션</br>' + response.body+'</h4>';
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $.each(response, function(key,value){
                        ...
                        str += '</br><h4>포지션</br>' + value.body+'</h4>';
                        str += '<hr/>'
                        str += '</div>';          
                    });
                    $("#guest").append(str);
